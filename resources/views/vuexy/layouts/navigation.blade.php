<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item @yield('Permiso')"><a class="d-flex align-items-center" href=""><i data-feather="shield"></i><span class="menu-title text-truncate" ></span></a>
            </li>
            <li class=" nav-item @yield('Rol')"><a class="d-flex align-items-center" href=""><i data-feather="shield"></i><span class="menu-title text-truncate" ></span></a>
            </li>
            <li class=" nav-item @yield('Usuarios') "><a class="d-flex align-items-center" href=""><i data-feather='users'></i><span class="menu-title text-truncate" data-i18n="Chat"></span></a>
            </li>
