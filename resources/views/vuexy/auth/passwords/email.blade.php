                        ...
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <form class="auth-forgot-password-form mt-2" action="{{ route('password.email') }}" method="POST">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" type="email" id="email" name="email" placeholder="juan@ejemplo.com" aria-describedby="forgot-password-email" autofocus="" tabindex="1" value="{{ old('email') }}" />
                                    @if ($errors->has('email'))
...
@endpush
@push('scripts-page')
    <script src="{!! asset('assets/js/pages/auth-forgot-password.js') !!}"></script>
    <script>
