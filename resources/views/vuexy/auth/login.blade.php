                        ...
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" name="email" placeholder="juan@example.com" aria-describedby="login-email" autofocus="" tabindex="1" value="{{ old('email') }}"/>
                                    @if ($errors->has('email'))
