...
<!--/ upgrade your plan Modal -->
<!-- Edit Account -->
<div class="modal fade text-start" id="confirmForm" tabindex="-1" aria-labelledby="myModalLabel24" aria-hidden="true" >
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel24">{{ trans('modals.form_modal_default_title') }}</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-footer">
                {!! Form::button('<i data-feather="x-circle" class="me-25"></i> ' . trans('modals.form_modal_default_btn_cancel'), array('class' => 'btn btn-secondary', 'type' => 'button', 'data-bs-dismiss' => 'modal' )) !!}
                {!! Form::button('<i data-feather="check" class="me-25"></i> ' . trans('modals.form_modal_default_btn_submit'), array('class' => 'btn btn-primary', 'type' => 'button', 'id' => 'confirm' )) !!}
            </div>
        </div>
    </div>
</div>
...
<!-- Modal -->
{{--<div class="modal fade text-start modal-success" id="exampleModal" tabindex="-1" aria-labelledby="myModalLabel24" aria-hidden="true" >--}}
{{--        <div class="modal-dialog">--}}
{{--            <div class="modal-content">--}}
{{--                <div class="modal-header">--}}
